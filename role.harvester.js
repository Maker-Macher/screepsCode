...
var roleHarvester = {
    ...
    run: function(creep){
        ...
        if(creep.store.getFreeCapacity() > 1) {
            ...
            if(base.store[RESOURCE_ENERGY] == 300){     //otherwise checks if base is full (capacity of 300), if it is
                ...
                if(creep.transfer(base, RESOURCE_ENERGY) == ERR_NOT_IN_RANGE) {     //otherwisse transfer it to the base
                    creep.moveTo(base)
                }
            }
        }
